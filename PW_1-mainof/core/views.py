...
def carrera_pdf_list(request):
    ...
    if selected_carrera_id:
        ...
        pdfscuarto = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Segundo", semestre__icontains="Segundo") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Segundo", semestre__icontains="Cuarto")
        pdfsquinto = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Tercero", semestre__icontains="Primer") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Tercero", semestre__icontains="Quinto")
        pdfssexto = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Tercero", semestre__icontains="Segundo") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Tercero", semestre__icontains="Sexto")
        pdfsseptimo = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Cuarto", semestre__icontains="Primer") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Cuarto", semestre__icontains="Septimo")
        pdfsoctavo = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Cuarto", semestre__icontains="Segundo") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Cuarto", semestre__icontains="Octavo")
        pdfsnoveno = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Quinto", semestre__icontains="Primer") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Quinto", semestre__icontains="Noveno")
        pdfsdecimo = PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Quinto", semestre__icontains="Segundo") | PDF.objects.filter(id_carrera=selected_carrera, curso__icontains="Quinto", semestre__icontains="Decimo")

    return render(request, 'carrera_pdf_list.html',
                  {'carreras': carreras, 'pdfs': pdfs, 'selected_carrera_id': selected_carrera_id, 'pdfsprimer': pdfsprimer,'pdfssegundo': pdfssegundo,
                    'pdfstercero': pdfstercero,'pdfscuarto': pdfscuarto,'pdfsquinto': pdfsquinto,'pdfssexto': pdfssexto,'pdfsseptimo': pdfsseptimo,
                    'pdfsoctavo': pdfsoctavo,'pdfsnoveno': pdfsnoveno,'pdfsdecimo': pdfsdecimo})
